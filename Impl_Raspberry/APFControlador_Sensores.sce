...
// Abre o diretorio
// getd('E:\Kamilla - IC\Arquivos\APF e Controlador'); // Windows
getd('/media/pi/5F25-1788/Versao2704/');
//getd('/media/pi/Download')
//getd('/home/kamilla/Área de trabalho/Kamilla - IC/Arquivos/APF e Controlador');

// Carrega os parametros
//exec('E:\Kamilla - IC\Arquivos\APF e Controlador\parametros_apf.sci',-1)// Windows
//exec('/media/kamilla/991373098/Kamilla - IC/Arquivos/APF e Controlador/parametros_apf.sci',-1);
//exec('/home/kamilla/Área de trabalho/Kamilla - IC/Arquivos/APF e Controlador/parametros_apf.sci', -1);
//exec('/media/pi/Download/parametros_apf.sci', -1);
...
recebido = readserial(arduino_com, 1);
    ...
    if ascii(recebido)== 2 then //Inicio do texto
           ...
           // obs_mov = [(dados(m,4:6).*cos(dados(m,7:9))+robo_pos(m,1))', (dados(m,4:6).*sin(dados(m,7:9))+robo_pos(m,2))'];
